...
-------------------------------------------------
--local bRandomWallpaperOnLoad = Modding.GetSystemProperty("bRandomWallpaperOnLoad")
--Controls.BG_Checkbox:SetCheck(bRandomWallpaperOnLoad == "1")

--Controls.BG_Checkbox:RegisterCheckHandler( function(bCheck)
    --if(bCheck) then
        --Modding.SetSystemProperty("bRandomWallpaperOnLoad", "1");
    --else
        --Modding.SetSystemProperty("bRandomWallpaperOnLoad", "0");
    --end

    --bRandomWallpaperOnLoad = Modding.GetSystemProperty("bRandomWallpaperOnLoad")
    --Controls.BG_Checkbox:SetCheck(bRandomWallpaperOnLoad == "1")
--end);

--Controls.NextBackgroundButton:RegisterCallback( Mouse.eLClick, function()
--	LuaEvents.Suk_ChangeBackground(1)
--end)
...
-------------------------------------------------
-- Drafter Button Handler
-------------------------------------------------
--function DrafterClick()
--    UIManager:QueuePopup( Controls.DraftPicker_FrontEnd, PopupPriority.DraftPicker );
--end
--Controls.DraftPickerButton:RegisterCallback( Mouse.eLClick, DrafterClick );
