...
function UpdatePlayer( slotInstance, playerInfo )
	...
	if(slotInstance ~= nil) then
		...
		if( civIndex ~= -1 and activeCivSlot ) then
			...
			slotInstance.CivLabel:LocalizeAndSetText( Locale.ConvertTextKey( civ.ShortDescription ), "TXT_KEY_RANDOM_LEADER_CIV", Locale.ConvertTextKey( leaderDescription ) );
...
function UpdateLocalPlayer( playerInfo )
	...
	if( civIndex ~= -1 and activeCivSlot ) then
		...
		Controls.CivLabel:LocalizeAndSetText( Locale.ConvertTextKey( civ.ShortDescription ), "TXT_KEY_RANDOM_LEADER_CIV", Locale.ConvertTextKey( leaderDescription ) );
