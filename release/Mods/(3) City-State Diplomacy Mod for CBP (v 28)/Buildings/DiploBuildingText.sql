...
INSERT INTO Language_en_US (
  Tag, Text)
SELECT 'TXT_KEY_BUILDING_WIRE_SERVICE_HELP', '+20% [ICON_PRODUCTION] Production of Diplomatic Units in this City. Grants Promotion [COLOR_POSITIVE_TEXT]Wire Service[ENDCOLOR] for Diplomatic Units in the city in which it is built. [NEWLINE][NEWLINE]+1 [ICON_CULTURE] Culture in City for every City-State Friend, and +1 [ICON_RESEARCH] Science for every Ally.';