			...
			if civ_leader then
				...
				if leader then
					...
					for override in GameInfo.Civilization_BuildingClassOverrides("CivilizationType = '" .. civ.Type .. "'") do
						...
						local building = override.BuildingType;

						if building then
							count = count + 1;
							local instance = slot.civManager:GetInstance();
							IconHookup(GameInfo.Buildings[override.BuildingType].PortraitIndex, 64, GameInfo.Buildings[override.BuildingType].IconAtlas, instance.CivPortrait);
							SetIconHelp(instance.CivPortrait, GameInfo.Buildings[override.BuildingType].Description, GameInfo.Buildings[override.BuildingType].Help, GameInfo.Buildings[override.BuildingType].Strategy);
						end
					end
