...
SELECT 'ECONOMICAISTRATEGY_NEED_HAPPINESS', 'FLAVOR_DIPLOMACY', 20
WHERE EXISTS (SELECT * FROM CSD WHERE Type='CSD_AI' AND Value= 1 );

INSERT INTO AIEconomicStrategy_Player_Flavors (
AIEconomicStrategyType, FlavorType, Flavor)
SELECT 'ECONOMICAISTRATEGY_EXPAND_TO_OTHER_CONTINENTS', 'FLAVOR_DIPLOMACY', 15
WHERE EXISTS (SELECT * FROM CSD WHERE Type='CSD_AI' AND Value= 1 );

INSERT INTO AIEconomicStrategy_Player_Flavors (
AIEconomicStrategyType, FlavorType, Flavor)
SELECT 'ECONOMICAISTRATEGY_EXPAND_LIKE_CRAZY', 'FLAVOR_DIPLOMACY', 10
WHERE EXISTS (SELECT * FROM CSD WHERE Type='CSD_AI' AND Value= 1 );
...
INSERT INTO AIEconomicStrategy_Player_Flavors (
AIEconomicStrategyType, FlavorType, Flavor)
SELECT 'ECONOMICAISTRATEGY_GS_SPACESHIP', 'FLAVOR_DIPLOMACY', 10
WHERE EXISTS (SELECT * FROM CSD WHERE Type='CSD_AI' AND Value= 1 );
...
SELECT 'MILITARYAISTRATEGY_EMPIRE_DEFENSE', 'FLAVOR_DIPLOMACY', -30
WHERE EXISTS (SELECT * FROM CSD WHERE Type='CSD_AI' AND Value= 1 );
...
INSERT INTO AIMilitaryStrategy_Player_Flavors (
AIMilitaryStrategyType, FlavorType, Flavor)
SELECT 'MILITARYAISTRATEGY_AT_WAR', 'FLAVOR_DIPLOMACY', -100
WHERE EXISTS (SELECT * FROM CSD WHERE Type='CSD_AI' AND Value= 1 );
