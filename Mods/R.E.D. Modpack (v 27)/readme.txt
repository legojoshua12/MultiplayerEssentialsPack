...
- Diversity : hundreds of new unit models for diversity, no gameplay change. See newunits.xls or forum thread on civfanatics website for details
...
- launch civ5, go to the mod menu, it should be extracted automatically
- find the "R.E.D. Modpack" line and activate the mod.
- click "next", then "single player" and set up a game
...
- add 4 ethnic units :
	...
	Ottoman rifleman
	Russian rifleman
- update 1 ethnic units :
	updated version of German rifleman
- fix :
	replace S-Class (was not English but German model) to T-Class for England (thanks to Nutty for reporting this one !) 
...
- change : give name to units for WB use
- add 12 ethnic units : 
...
5f779307-3810-439c-9c9e-1c86be3c86cd = Ethnic Diversity
 ...
 maxversion="9999"/>
  ...
  civ5_nedwa1.fxsxml (netherland warrior)
  Quechua.fxsxml
...
[b]Regiment and Ethnic Diversity[/b] for Civilization V & G+K (and DLC)
...
For mac user or manual installation, there is a direct download link on [url=http://forums.civfanatics.com/downloads.php?do=file&id=15434]civfanatics[/url]
...
Close steam (not just the windows, the compete program, in doubt restart your computer)
